sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("nm1/zsample1/app", ".html");
		...
		return Opa5.extend("nm1.zsample1.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["nm1/zsample1/localService/mockserver"], function (mockserver) {
